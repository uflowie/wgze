          ...
          {foods.map(food => (
            ...
            >
                ...
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div class="flex gap-2 mt-3 sm:mt-0 sm:ml-4">
                    ...
                    <button
                      ...
                      hx-delete={`/dishes/${food.id}`}
                      hx-target="#food-list"
                      hx-target-500="#food-list"
                      hx-swap="innerHTML"
              ...
              <div class="food-edit hidden">
                <form hx-put={`/dishes/${food.id}`} hx-target="#food-list" hx-target-400="#food-list" hx-target-500="#food-list" hx-swap="innerHTML" hx-on--after-request="if(event.detail.successful) this.reset()" class="space-y-4">
                  <div>
